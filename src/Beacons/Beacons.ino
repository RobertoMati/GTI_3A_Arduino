...
//------------PINES PARA LA LECTURA------------
int Vgas = A5;
int Vref = A4;
int Vtmp = A3;

//--------PINES PARA LA CALIBRACIÓN-----------
double offset=0;
int Vgas_value = 0;
int Vref_value = 0;
int Vtmp_value = 0;
...
//---------------------------------------------
/**
   * @brief esta función se encarga de hacer la media
   * @return 
   * Diseño:  --> promediar() --> 
   **/
float promediar(){
...
//--------------------------------------------------
/**
   * @brief esta función se encarga de aplicar la fórmula para sacar el valor en ppm
   * @return 
   * Diseño:  --> medidasVref() --> 
   **/ 
...
//--------------------------------------------------
/**
   * @brief esta función se encarga de inicializar arduino
   * @return 
   * Diseño:  --> setup() --> 
   **/
...
//--------------------------------------------------
/**
   * @brief esta función se encarga de inicializar el envio de Beacons
   * @return 
   * Diseño:  --> ComienzoEnvioBeacons() --> 
   **/
